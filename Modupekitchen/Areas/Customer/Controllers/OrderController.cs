...
namespace Modupekitchen.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Confirm(int id)
        {
            ...
            {
                OrderHeader = await 
                                _db.OrderHeader.Include(o => 
                                o.ApplicationUser)
                                .FirstOrDefaultAsync(o => 
                                o.Id == id && o.UserId == claim.Value),
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            //await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Modupe-Kitchen - Order Ready for Pickup " + orderHeader.Id.ToString(), "call the dispatcher on 080..... to know his location.");
